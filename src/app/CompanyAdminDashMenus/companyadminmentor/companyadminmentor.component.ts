...
@Component({
  selector: 'app-companyadminmentor',
  templateUrl: './companyadminmentor.component.html',
  styleUrls: ['./companyadminmentor.component.scss']
})
export class CompanyadminmentorComponent implements OnInit{
