...
declare const $:any;
import { IndividualsearchmentorComponent } from '../individualsearchmentor/individualsearchmentor.component';
import { MentordetailsComponent } from '../../CompanyAdminDashMenus/mentordetails/mentordetails.component';
@Component({
  selector: 'app-individualmenteementor',
  templateUrl: './individualmenteementor.component.html',
  styleUrls: ['./individualmenteementor.component.scss']
})
export class IndividualmenteementorComponent implements OnInit{
